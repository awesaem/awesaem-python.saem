# 표준 입력 input을 이용하여 이름, 신장, 체중을 입력 받은 후 적정 평균 체중을 구하는  프로그램을 작성하시오.
#
...
if (standardWeight-5) < weight < (standardWeight+5) :
    print("%s님은 적정 체중입니다." % (name))
else:
    print("%s님은 적정 체중이 아닙니다." % (name))